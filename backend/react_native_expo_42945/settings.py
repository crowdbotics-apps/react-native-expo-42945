"""
Django settings for react_native_expo_42945 project.
...
ROOT_URLCONF = 'react_native_expo_42945.urls'
...
WSGI_APPLICATION = 'react_native_expo_42945.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "react_native_expo_42945 API",
    "DESCRIPTION": "API documentation for react_native_expo_42945 App",
    "VERSION": "v1",
}
